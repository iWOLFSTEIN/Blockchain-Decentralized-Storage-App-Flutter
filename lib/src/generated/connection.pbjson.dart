...
const TokenRequest$json = const {
  '1': 'TokenRequest',
  '2': const [
    const {'1': 'nodeNumber', '3': 1, '4': 1, '5': 9, '10': 'nodeNumber'},
  ],
};

/// Descriptor for `TokenRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tokenRequestDescriptor = $convert.base64Decode('CgxUb2tlblJlcXVlc3QSHgoKbm9kZU51bWJlchgBIAEoCVIKbm9kZU51bWJlcg==');
